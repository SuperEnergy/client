...
public class UserLineListActivity extends BaseRVActivity<UserMinePresenter, UserMine> implements UserMineContract.View {
    ...
    public void receiveRefreshUserMinesEvent(RefreshUserMinesEvent event) {
        mPresenter.getUserMineList(mUser.getPid(), MineType.TYPE_LINE);
    }
    ...
    @OnClick(R.id.clone_onekey)
    public void oneKeyClone(View view) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_add:
                startActivity(new Intent(App.getInstance().getApplicationContext(), LineListActivity.class));
                break;
        }
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_userline_list;
    }
...
//        refreshUsermineList(mDataList);
    ...
    public void configViews(Bundle savedInstanceState) {
        mTitle.setText(R.string.ees_line);
...
//        }
    ...
    public void unbindSuccess(Boolean result) {
        ...
        BLEAction.getInstance(App.getInstance().getBle(), UserLineListActivity.this).disconnect(App.getInstance().getCurrentDevice());
        ...
        if (!BluetoothAdapter.getDefaultAdapter().isEnabled()) {
            ...
            if (!openresult) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(UserLineListActivity.this, getString(R.string.err_open_ble), Toast.LENGTH_SHORT).show();
                    }
                });
                return;
            }
