...
/**
 * Created by KESION on 2018/7/19.
 */
...
public class ZXingUtils {
    ...
    // 图片叠加
    public static Bitmap mixtureBitmap(Bitmap src, Bitmap watermark) {
        // 另外创建一张图片
...
//                (src.getHeight() - watermark.getHeight()) / 2, null); // 涂鸦图片画到原图片中间位置
        canvas.drawBitmap(watermark,
                (src.getWidth() - watermark.getWidth() - 10),
                (src.getHeight() - watermark.getHeight() - 10), null); // 涂鸦图片画到原图片中间位置
